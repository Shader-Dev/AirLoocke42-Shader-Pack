...
void main() {
	...
	sum += calcDepth(offset[0], bias); 
	sum += calcDepth(offset[1], bias);
	sum += calcDepth(offset[2], bias); 
	sum += calcDepth(offset[3], bias);
	sum += calcDepth(offset[4], bias); 
	sum += calcDepth(offset[5], bias);
	sum += calcDepth(offset[6], bias); 
	sum += calcDepth(offset[7], bias);
	sum += calcDepth(offset[8], bias); 
	sum += calcDepth(offset[9], bias);
	sum += calcDepth(offset[10], bias); 
	sum += calcDepth(offset[11], bias);
	sum += calcDepth(offset[12], bias); 
	sum += calcDepth(offset[13], bias);
	sum += calcDepth(offset[14], bias); 
	sum += calcDepth(offset[15], bias);
	sum /= 16.0;
